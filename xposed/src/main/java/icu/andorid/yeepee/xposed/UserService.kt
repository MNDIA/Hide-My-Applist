...
import icu.andorid.yeepee.common.BuildConfig
...
object UserService {
    ...
    private const val TAG = "YEP-UserService"
    ...
    private val uidObserver = object : UidObserverAdapter() {
        override fun onUidActive(uid: Int) {
            ...
            try {
                ...
                val extras = Bundle()
                extras.putBinder("binder", YEPService.instance)
    ...
    fun register(pms: IPackageManager) {
        logI(TAG, "Initialize YEPService - Version ${BuildConfig.SERVICE_VERSION}")
        val service = YEPService(pms)
