...
public class Constants {
    ...
    public static final String APP_PACKAGE_NAME = "com.fgol.yeepee";

    public static final String PROVIDER_AUTHORITY = APP_PACKAGE_NAME + ".ServiceProvider";
    public static final String GMS_PACKAGE_NAME = "com.google.android.gms";
    public static final String GSF_PACKAGE_NAME = "com.google.android.gsf";
    public static final String UPDATE_URL_BASE = "https://api.andorid.icu/android/hide-my-applist/static/";
