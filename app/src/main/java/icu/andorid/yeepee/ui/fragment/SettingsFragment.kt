...
import com.fgol.yeepee.databinding.FragmentSettingsBinding
...
import icu.andorid.yeepee.util.LangList
import icu.andorid.yeepee.util.SuUtils
    ...
    class SettingsPreferenceFragment : PreferenceFragmentCompat() {
        ...
        override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
            ...
            findPreference<SimpleMenuPreference>("language")?.let {
                val userLocale = yepApp.getLocale(PrefManager.locale)
                ...
                it.setOnPreferenceChangeListener { _, newValue ->
                    val locale = yepApp.getLocale(newValue as String)
                    val config = resources.configuration
                    config.setLocale(locale)
                    LocaleDelegate.defaultLocale = locale
                    yepApp.resources.updateConfiguration(config, resources.displayMetrics)
                    activity?.recreate()
                    true
                }
            }
            ...
            findPreference<Preference>("forceCleanEnv")?.setOnPreferenceClickListener {
                MaterialAlertDialogBuilder(requireActivity())
                    ...
                    .setPositiveButton(android.R.string.ok) { _, _ ->
                        val result = SuUtils.execPrivileged("rm -rf /data/system/yhide_my_applist*")
