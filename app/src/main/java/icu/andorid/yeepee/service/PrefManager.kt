...
object PrefManager {
    ...
    private const val PREF_HIDE_ICON = "yhide_icon"
    ...
    private val pref = yepApp.getSharedPreferences("settings", MODE_PRIVATE)
    ...
    var hideIcon: Boolean
        ...
        set(value) {
            ...
            val component = ComponentName(yepApp, "com.fgol.yeepee.MainActivityLauncher")
            val status =
                if (value) PackageManager.COMPONENT_ENABLED_STATE_DISABLED
                else PackageManager.COMPONENT_ENABLED_STATE_ENABLED
            yepApp.packageManager.setComponentEnabledSetting(component, status, PackageManager.DONT_KILL_APP)
        }
