package icu.andorid.yeepee.service
...
import icu.andorid.yeepee.common.IYEPService
import java.lang.reflect.InvocationHandler
import java.lang.reflect.Method
import java.lang.reflect.Proxy

object ServiceClient : IYEPService, DeathRecipient {

    private const val TAG = "ServiceClient"

    private class ServiceProxy(private val obj: IYEPService) : InvocationHandler {
    ...
    @Volatile
    private var service: IYEPService? = null

    fun linkService(binder: IBinder) {
        service = Proxy.newProxyInstance(
            javaClass.classLoader,
            arrayOf(IYEPService::class.java),
            ServiceProxy(IYEPService.Stub.asInterface(binder))
        ) as IYEPService
        binder.linkToDeath(this, 0)
    }

    private fun getServiceLegacy(): IYEPService? {
        ...
        val remote = try {
            ...
            IYEPService.Stub.asInterface(binder)
